...
const ANSWERS: Answer[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Then open Compare Mutations or Copy Number to analyze just those samples.',
    ],
  ...
  },
  {
    ...
    steps: [
      'Select samples, then open Compare Mutations.',
    ...
    takeMeThere: { label: 'Open Compare Mutations', action: { kind: 'navigate', view: 'mutations', tab: 'compare', tour: 'tab-compare' } },
    showMe: 'comparative',
  ...
  },
  {
    ...
    icon: <Layers className="w-4 h-4" />,
    steps: [
      'In Compare Mutations, a mutation supplied as donor DNA has an amber outline over its frequency color.',
  ...
  },
  {
    ...
    steps: [
      'Click any OD600 sparkline (in Sample Selection or Compare Mutations) to open the full growth-curve popup.',

...
export function AppShell({ children }: Readonly<{ children: ReactNode }>) {
 return <div className="app-shell">
  <header className="topbar"><Link className="brand" href="/mutations/cohort">AI-ALE / LIVE RESEARCH</Link><div className="header-meta"><span className="provenance">{mockProvenance.label}</span><span>Read-only</span><a href="https://github.com/VibhavSetlur/ai-ale-lims-data-viewer/issues" target="_blank" rel="noreferrer">Report an issue</a><span aria-label="Account status">Anonymous</span></div></header>

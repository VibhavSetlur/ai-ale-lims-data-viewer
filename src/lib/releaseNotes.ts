...
export const releaseNotes: readonly ReleaseNote[] = [
  { version: '1.15.1', date: '2026-09-21', summary: 'Static exports now record the canonical LIMS mirror SHA-256 and verify that Mutation Explorer snapshots, table metadata, and the HTTPVFS database all derive from that same source.' },

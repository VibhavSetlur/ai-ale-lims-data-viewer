...
| [`DEPLOYMENT_VERSIONING.md`](DEPLOYMENT_VERSIONING.md) | Version badge, deploy branch pointers, staging/public/private differences, and promotion workflow | Developers, maintainers, reviewers |
